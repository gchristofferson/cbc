            ...
            <div class="mb-4">
                <div class="card card-small h-100">
                    ...
                    <div class="d-flex flex-column">
                        <form method="POST" action="/inquiries" enctype="multipart/form-data" class="card-body" id="create-inquiry">
                            @csrf
                            <div class="form-group">
                                <input type="text" class="form-control" id="feInputSubject" placeholder="Subject" name="subject" required value="{{ old('subject') }}{{ session('data.subject') }}">
                            </div>
                            <div class="form-group">
                                <textarea class="form-control" placeholder="Message" name="body">{{ old('body') }}{{ session('data.body') }}</textarea>
                            </div>
                            <!-- Select -->
                            @if (session('data.paths'))
                                ...
                                @endforeach
                                <input type="hidden" id="documents_array" name="documents_array[]" value="@foreach ($documents as $document){{ $document }},@endforeach">
                            @endif
                            ...
                            <div class="form-group mb-1 row  mx-auto add-select">
                                ...
                                <a href="#" class="col-2 js-delBtn" id=""><i class="material-icons text-danger">clear</i></a>

                            </div>
                            <div class="add-link mb-0 mt-2 row container">
                                <a href="#" data-toggle="tooltip" id="add-city" data-placement="top" title="Add City"><i class="material-icons">add_circle_outline</i></a>
                                <div class="form-control is-invalid mt-4 mb-4 city-error col-10" style="display: none;">
                                    <ul class="row">
                                        ...
                                        <a href="#" class="col-2 js-city-error-delete" id=""><i class="material-icons text-danger">clear</i></a>
                                    </ul>
                        ...
                        {{--@endif--}}
                            ...
                            <div class="border-top card-footer">
                                ...
                                <div class="add-link mb-0 row container">
                                    <a href="#" data-toggle="tooltip" data-placement="top" id="add-doc" title="Add Attachment"><i class="material-icons">attachment</i></a>
                                    <div class="form-control is-invalid mt-4 mb-4 upload-error col-10" style="display: none;">
                                        <ul class="row">
                                            <li class="col-10">There is no document attached to delete.</li>
                                            <a href="#" class="col-2 js-upload-error-delete" id=""><i class="material-icons text-danger">clear</i></a>
                                        </ul>
