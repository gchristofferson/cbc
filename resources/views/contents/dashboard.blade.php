            ...
            <div class="card card-small user-details mb-4">
                <div class="card-header p-0">
                    <div class="user-details__bg">
                        <img src="{{ asset("img/user-profile/$user->background_img") }}"
                             alt="User Details Background Image"></div>
                </div>
                ...
                <div class="user-details__user-data border-top border-bottom p-4">
                    ...
                    <div class="card-footer border-top mt-4">
                        <a href="/inquiries/create" class="btn mb-2 btn btn-primary mr-2 d-table mx-auto">Make
                            Inquiry</a>
                    </div>
                ...
                @foreach( array_slice($received_inquiries, 0,4) as $received_inquiry )
                    <div class="user-activity__item pr-3 py-3" data-type="received">
                        ...
                        <div class="user-activity__item__content">
                            <span class="text-light">{{ $received_inquiry['created_at'] }}</span>

                            @if( $received_inquiry['read'] == 0)
                                <p><span class="font-weight-bold">{{ $received_inquiry['subject'] }}</span>
                                    | {{ str_limit(strip_tags($received_inquiry['body']), $limit = 30, $end = '...') }}
                                </p>
                            @else
                                <p>{{ $received_inquiry['subject'] }}
                                    | {{ str_limit(strip_tags($received_inquiry['body']), $limit = 30, $end = '...') }}</p>
                            @endif

                        </div>
                        <div class="row ml-auto">
                            <div class="user-activity__item__action ml-auto mr-1">
                                <a href="/inquiries/{{ $received_inquiry['id'] }}"
                                   class="ml-auto btn btn-sm btn-white">View Inquiry</a>
                            </div>
                ...
                @foreach( array_slice($sent_inquiries, 0, 4) as $sent_inquiry )
                    <div class="user-activity__item pr-3 py-3" data-type="sent">
                        ...
                        <div class="user-activity__item__content">
                            ...
                            <p>{{ $sent_inquiry[0]['subject'] }}
                                | {{ str_limit(strip_tags($sent_inquiry[0]['body']), $limit = 30, $end = '...') }}</p>
                        </div>
                        <div class="row ml-auto">
                            <div class="user-activity__item__action ml-auto mr-1">
                                <a href="/inquiries/{{ $sent_inquiry[0]['id'] }}" class="ml-auto btn btn-sm btn-white">View
                                    Inquiry</a>
                            </div>
                            <div class="user-activity__item__action ml-auto mr-3">
                ...
                @foreach( $saved_inquiries as $saved_inquiry)
                    <div class="user-activity__item pr-3 py-3" data-type="saved">
                        ...
                        <div class="user-activity__item__content">
                            ...
                            <p>{{ $saved_inquiry[0]['subject'] }}
                                | {{ str_limit(strip_tags($saved_inquiry[0]['body']), $limit = 30, $end = '...') }}</p>
                        </div>
                        <div class="row ml-auto">
                            <div class="user-activity__item__action ml-auto mr-1">
                                <a href="/inquiries/{{ $saved_inquiry[0]['id'] }}" class="ml-auto btn btn-sm btn-white">View
                                    Inquiry</a>
                            </div>
                            <div class="user-activity__item__action ml-auto mr-3">
